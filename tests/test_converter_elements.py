...
class TestConvertPdfToElements:
    def test_single_pass_returns_elements(self, mock_ai_backend, valid_pdf_bytes):
        with patch(
    ...
    def test_image_report_passed_to_backend(self, mock_ai_backend, valid_pdf_bytes):
    ...
    def test_empty_result_falls_back_to_paragraph(self, mock_ai_backend, valid_pdf_bytes):
