...
| `ENABLE_PAGE_CREATION`             | `False`                                                       | Enables the **Create page from PDF** admin action. See [Creating pages from PDFs](guides/creating-pages.md).                                                                                                                               |
| `PAGE_CREATION_MODEL`              | `None`                                                        | Dotted path to the Page model created from PDFs (e.g. `"myapp.models.PDFPage"`). Required for page creation.                                                                                                                              |
| `PAGE_CREATION_PARENT_ID`          | `None`                                                        | Primary key of the page under which PDF-derived pages are created. Required for page creation.                                                                                                                                           |
